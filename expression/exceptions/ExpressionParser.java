            ...
            switch (token.getType()) {
                case END:
                    if (isLeftBracketPresent) {
                        throw new ParsingException("no closing parenthesis", lastLeftBracket);
                    }
                    break;
                case LEFT_BR:
                ...
                case RIGHT_BR:
                    if (!isLeftBracketPresent) {
                        throw new ParsingException("no opening parenthesis", token.getIdx());
                    }
                    break;
                default:
    ...
    private TripleExpression primary() throws ParsingException {
        ...
        switch (token.getType()) {
            ...
            case LEFT_BR:
                ...
                return primary;
            case POW10:
                primary = new CheckedPow10(primary());
                break;

            case LOG10:
                primary = new CheckedLog10(primary());
                break;
