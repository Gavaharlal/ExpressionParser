...
class TabulateExecutor<T extends Number> {
    private Function<String, Type<T>> parser;

    TabulateExecutor(Function<String, Type<T>> parser) {
        this.parser = parser;
    }

    Object[][][] execute(String expr, int x1, int x2, int y1, int y2, int z1, int z2) throws Exception {
