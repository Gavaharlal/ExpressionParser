...
public class ParserTest extends BaseTest {
    ...
    final List<List<Op<LongBinaryOperator>>> levels = new ArrayList<>();
    ...
    private static final Reason DBZ = new Reason("Division by zero");
    ...
    public static class ExpException extends RuntimeException {
        ...
        ExpException(final Reason reason) {
            super(reason.description);
            this.reason = reason;
        }
    }

    protected static long error(final Reason reason) {
